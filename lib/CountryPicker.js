...
export const CountryPicker = (props) => {
    ...
    useEffect(() => {
        getCountriesAsync(withEmoji ? FlagType.EMOJI : FlagType.FLAT, translation, region, subregion, countryCodes, excludeCountries)
            .then(setCountries)
            .catch(console.warn);
