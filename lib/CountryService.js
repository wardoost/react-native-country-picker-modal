...
const imageJsonUrl = 'http://xcarpentier.github.io/react-native-country-picker-modal/countries/';
const localData = {
...
const isExcluded = (excludeCountries) => (country) => excludeCountries && excludeCountries.length > 0
    ...
    : true;
export const getCountriesAsync = async (flagType, translation = 'common', region, subregion, countryCodes, excludeCountries) => {
